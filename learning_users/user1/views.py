...
from user1.models import User,UserProfileInfo
...
def register(request):
    ...
    return render(request,'user1/registration.html',{'user_form':user_form,'profile_form':profile_form,'registered':registered})
